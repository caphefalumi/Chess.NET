...
namespace Chess.Core
{
    public class Board : IDrawable
    {
        ...
        private HashSet<Chess.UI.Drawing.Circle> _boardHighlights;
        private Chess.UI.Drawing.Rectangle[] _backgroundOverlays;
        ...
        public HashSet<Chess.UI.Drawing.Circle> BoardHighlights
        {
            get => _boardHighlights;
            set => _boardHighlights = value;
        }

        public Chess.UI.Drawing.Rectangle[] BackgroundOverlays
        {
        ...
        private Board(int squareSize, int startX, int startY, Color lightColor, Color darkColor)
        {
            ...
            _boardHighlights = new HashSet<Chess.UI.Drawing.Circle>();
            _backgroundOverlays = new Chess.UI.Drawing.Rectangle[3];
