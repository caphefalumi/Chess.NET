    ...
    public class GameplayScreen : ScreenState, IGameObserver
    {
        ...
        public override void Render()
        {
            ...
            if (_gameOver)
            {
                ...
                Chess.UI.Drawing.Rectangle overlay = new Chess.UI.Drawing.Rectangle(Color.RGBAColor(0, 0, 0, 128), 0, 0, SplashKit.ScreenWidth(), SplashKit.ScreenHeight());
                overlay.Draw();
                
                // Draw game over text
                SplashKit.DrawText(_gameOverMessage, Color.White, Chess.UI.Drawing.Font.Arial, 36, SplashKit.ScreenWidth() / 2 - 200, SplashKit.ScreenHeight() / 2 - 50);
            ...
            SplashKit.DrawText(modeText, Color.Black, Chess.UI.Drawing.Font.Arial, 18, 650, 350);
        ...
        private void DrawPlayerInfo(Player player, int x, int y)
        {
            ...
            SplashKit.DrawText(playerName, textColor, Chess.UI.Drawing.Font.Arial, 14, x, y);
        ...
        private void DrawTimeDisplay(Player player, string timeStr, int x, int y)
        {
            ...
            SplashKit.DrawText(playerText + timeStr, textColor, Chess.UI.Drawing.Font.Arial, 20, x, y);
        }
