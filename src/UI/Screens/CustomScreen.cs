...
namespace Chess.UI.Screens
{
    public class CustomScreen : ScreenState
    {
        ...
        public override void Render()
        {
            ...
            SplashKit.DrawText("Custom Game Setup", Color.Black, Chess.UI.Drawing.Font.Arial, 24, SplashKit.ScreenWidth() / 2 - 120, 20);
            ...
            SplashKit.DrawText($"Time: {timeText}", Color.Black, Chess.UI.Drawing.Font.Arial, 14, 360, 15);

            // Draw piece color buttons
            SplashKit.DrawText("Piece Color:", Color.Black, Chess.UI.Drawing.Font.Arial, 16, 650, 70);
            ...
            SplashKit.DrawText("Piece Type:", Color.Black, Chess.UI.Drawing.Font.Arial, 16, 650, 180);
            foreach (KeyValuePair<PieceType, Button> entry in _pieceTypeButtons)
            {
        ...
        {
            Chess.UI.Drawing.Rectangle highlightRect = new Chess.UI.Drawing.Rectangle(Color.Green, button.X - 5, button.Y - 5, button.Width + 10, button.Height + 10);
            highlightRect.Draw();
        }
