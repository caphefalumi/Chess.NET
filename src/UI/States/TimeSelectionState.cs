...
namespace Chess.UI.States
{
    public class TimeSelectionScreen : ScreenState
    {
        ...
        public override void Render()
        {
            ...
            // Draw header
            SplashKit.DrawText("Select Time Control", Color.Black, Chess.UI.Drawing.Font.Arial, 28, 
                SplashKit.ScreenWidth() / 2 - 140, 80);
            
            // Draw time options section
            SplashKit.DrawLine(Color.LightGray, 100, 140, 600, 140);
            SplashKit.DrawText("Time per player:", Color.Black, Chess.UI.Drawing.Font.Arial, 18, 100, 150);
            ...
            SplashKit.DrawText("Increment per move:", Color.Black, Chess.UI.Drawing.Font.Arial, 18, 100, 330);
