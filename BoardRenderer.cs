    ...
    public class BoardRenderer
    {
        ...
        private void DrawIndices()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                SplashKit.DrawText(files[i], _textColor, Font.Arial, 16, fileX + 25, _startY + (8 * _squareSize) - 20);

                // Draw rank numbers (left side)
                SplashKit.DrawText((i + 1).ToString(), _textColor, Font.Arial, 16, _startX - MARGIN + 25, rankY + 15);
            }
        }
